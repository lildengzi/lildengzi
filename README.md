...
<table>
  <tr>
    ...
    <td width="50%">
      <h3>🦀 C / C++ / Rust</h3>
      <p>Strengthening programming fundamentals, data structures, memory understanding, and problem-solving skills. Rust for safer systems programming.</p>
      <p><strong>C / C++ / Rust</strong>：打基础，练数据结构、内存理解。用 Rust 写更安全的系统程序。</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
